...
const handleChange=(e)=>{
  ...
  setData(data => ({
    ...
    return (
     ...
     {editMode? (<form>
        <button type='button' onClick={()=>{setAction("text")}}>Text</button><button type='button' onClick={()=>{setAction("index")}}>Index</button><button type='button' onClick={()=>{setAction("status")}}>Status</button>
        <input 
        required
        maxLength={30}
